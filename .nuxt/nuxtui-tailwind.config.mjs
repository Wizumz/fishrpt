      ...
      import { customSafelistExtractor, generateSafelist } from "/workspace/node_modules/@nuxt/ui/dist/runtime/utils/colors";
      ...
      export default {
        ...
        content: {
          files: [
            "/workspace/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/workspace/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
