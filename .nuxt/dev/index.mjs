...
import { OpenAI } from 'file:///workspace/node_modules/openai/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///workspace/node_modules/ufo/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///workspace/node_modules/unstorage/dist/index.mjs';
...
import { Youch } from 'file:///workspace/node_modules/nitropack/node_modules/youch/build/index.js';
...
import { isVNode, toValue, isRef } from 'file:///workspace/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename } from 'file:///workspace/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///workspace/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///workspace/.nuxt/nuxt-icon-server-bundle.mjs';
...
const _91BKsdfmooUhWCFqXVuBlBeyIaZlB2VfqK2xI1p4gE = (nitroApp) => {
...
_91BKsdfmooUhWCFqXVuBlBeyIaZlB2VfqK2xI1p4gE,
...
const getServerEntry = () => import('file:///workspace/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///workspace/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_sJtn8l = () => Promise.resolve().then(function () { return fishingReport_post$1; });
const _lazy_DgkTPv = () => Promise.resolve().then(function () { return geocode_post$1; });
...
const handlers = [
  ...
  { route: '/api/fishing-report', handler: _lazy_sJtn8l, lazy: true, middleware: false, method: "post" },
  { route: '/api/geocode', handler: _lazy_DgkTPv, lazy: true, middleware: false, method: "post" },
...
const fishingReport_post = defineEventHandler(async (event) => {
  ...
  try {
    ...
    if (weatherData.status === "fulfilled") {
      ...
      processedData.weather.forecast = ((_a = weather.hourly) == null ? void 0 : _a.slice(0, 168)) || [];
    }
    if (marineData.status === "fulfilled") {
      const marine = marineData.value;
      processedData.waterTemp = ((_c = (_b = marine.hourly) == null ? void 0 : _b.sea_surface_temperature) == null ? void 0 : _c[0]) || 0;
      processedData.windSpeed = ((_e = (_d = marine.hourly) == null ? void 0 : _d.wind_speed_10m) == null ? void 0 : _e[0]) || 0;
      processedData.windDirection = ((_g = (_f = marine.hourly) == null ? void 0 : _f.wind_direction_10m) == null ? void 0 : _g[0]) || 0;
      processedData.waveHeight = ((_i = (_h = marine.hourly) == null ? void 0 : _h.wave_height) == null ? void 0 : _i[0]) || 0;
      processedData.waveDirection = ((_k = (_j = marine.hourly) == null ? void 0 : _j.wave_direction) == null ? void 0 : _k[0]) || 0;
    }
...
async function fetchTidesData(lat, lon) {
  try {
...
async function fetchSolunarData(lat, lon) {
  try {
...
function calculateFishingScore(data) {
  ...
  const moonPhase = ((_a = data.moonPhase) == null ? void 0 : _a.toLowerCase()) || "";
...
async function generateAIInsights(data, apiKey) {
  var _a, _b;
  try {
...
Water Temperature: ${data.waterTemp}\xB0F
Wind: ${data.windSpeed} mph from ${data.windDirection}\xB0
...
Keep the response concise but informative, around 150-200 words.`;
    ...
    return ((_b = (_a = completion.choices[0]) == null ? void 0 : _a.message) == null ? void 0 : _b.content) || generateBasicInsights(data);
  } catch (error) {
...
function generateBasicInsights(data) {
  ...
  insights += `Water temperature of ${data.waterTemp}\xB0F is ${data.waterTemp >= 55 && data.waterTemp <= 75 ? "ideal" : "acceptable"} for most fish species.`;
  return insights;
}
...
const fishingReport_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: fishingReport_post
}, Symbol.toStringTag, { value: 'Module' }));

const geocode_post = defineEventHandler(async (event) => {
  var _a, _b, _c;
  ...
  try {
    ...
    if (response && response.geometry) {
      ...
      return {
        lat: parseFloat(lat),
        lon: parseFloat(lon),
        name: ((_c = (_b = (_a = response.properties) == null ? void 0 : _a.relativeLocation) == null ? void 0 : _b.properties) == null ? void 0 : _c.city) || query
      };
    }
  } catch (error) {
    ...
    const popularLocations = [
      ...
      { name: "Key West, FL", lat: 24.5551, lon: -81.78 },
    ...
    const foundLocation = popularLocations.find(
      (loc) => loc.name.toLowerCase().includes(query.toLowerCase()) || query.toLowerCase().includes(loc.name.toLowerCase().split(",")[0])
    );
    if (foundLocation) {
...
const geocode_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: geocode_post
}, Symbol.toStringTag, { value: 'Module' }));
